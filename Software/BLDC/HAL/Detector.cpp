...
//
//static Fifo<int16_t, 1500> buffer __attribute__ ((section (".ccmram")));;
//
//static constexpr int ADCInspectionTimeus = 50;
//static constexpr int ADCBufferLength = 12;
//
...
//
//	TIM1->CCR4 = 160 - OverallTimerCycles;
...
//			static int16_t changeFilt;
//			if (buffer.getLevel() == 0) {
//				// first sample, get zero
//				last = data[sensingPhase];
//				changeFilt = 0;
//			}
//			int16_t change = data[sensingPhase] - last;
//			last = data[sensingPhase];
//			changeFilt -= changeFilt / 10;
//			changeFilt += change;
//			if (buffer.getSpace()) {
//				buffer.enqueue(data[sensingPhase]);
////			buffer.enqueue(changeFilt);
//			} else {
//				sampling = false;
//			}
//		}
